  ...
  return (
    ...
    <section className=" h-full w-full">
      <div className="h-screen flex flex-col items-center relative">
        ...
        <Link aria-label='Link to contact page where you can send ' className='btn relative z-30 top-[54%]  text-gray-50 hover:bg-accent hover:text-gray-50 text-base hover:scale-105' href={'/contact'}>Create Your Bespoke Leather Goods Today!</Link>
        <ScrollDownArrow/>
      </div>
    </section>
